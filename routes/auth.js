  ...
  fastify.get("/signup", async (request, reply) => {
    ...
    if (request.session.pendingLogin === true) {
      return reply.redirect(
        "/auth/verification?email=" + request.session.pendingLoginEmail,
      );
    }
  ...
  fastify.post("/resend", async (request, reply) => {
    ...
    try {
      ...
      return reply.send({
        ...
        error:
          error.message ||
          "Internal error while resending the code. Please try again later!",
      });
    }
  });
  ...
  fastify.post("/verify", async (request, reply) => {
    ...
    try {
      ...
      return reply.send({
        ...
        error:
          error.message ||
          "Internal error while verifying your login. Please try again later!",
      });
    }
  });
  ...
  fastify.post("/signup", async (request, reply) => {
    try {
      ...
      if (signupWith === "email") {
        ...
        if (
          isHuman.hostname !== "replit.dev" &&
          isHuman.hostname !== "localhost"
        ) {
          return reply.send({
            success: false,
      ...
      return reply.send({
        ...
        error:
          error.message ||
          "Internal error while signing up. Please try again later!",
      });
    }
  });
    ...
    try {
      ...
      if (
        ...
        return reply.send({
          success: false,
          error:
            "Please sign in with Google or link password with your Account!",
        });
      }
      ...
      return reply.send({
        ...
        error:
          error.message ||
          "Internal error while signing in. Please try again later!",
      });
    }
  });
};
